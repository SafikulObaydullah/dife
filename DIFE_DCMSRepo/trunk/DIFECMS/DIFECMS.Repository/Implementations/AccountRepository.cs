...
namespace DIFECMS.Repository.Implementations
{
    public class AccountRepository : IAccountRepository
    {
        ...
        {
            string SP = "InsertUpdateUserInfo_SP '" + o.Id + "','" + o.Name + "','" + o.Username + "','" + o.Password + "'," + o.UserTypeId + ",'" + o.Email + "','" + o.PhoneNo + "'," + o.OfficeId + "," + o.MinistryOrDepartmentId + "," + o.DesignationId + "," + o.isActive + "," + o.CreatorId + "";
