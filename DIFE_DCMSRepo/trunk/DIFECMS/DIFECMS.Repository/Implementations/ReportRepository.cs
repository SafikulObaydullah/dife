...
namespace DIFECMS.Repository.Implementations
{
    public class ReportRepository : IReportRepository
    {
        ...
        public List<CaseList> GetOfficeAndCourtWiseReportDetail(OfficeAndCourtWiseReportVM officeAndCourtWiseReportVM)
        {
            ...
            var SPname = "OfficeAndCourtWiseReport_Detail_SP '" + officeAndCourtWiseReportVM.IssueDateFrom + "','" + officeAndCourtWiseReportVM.IssueDateTo + "'," + officeAndCourtWiseReportVM.OfficeId + "," + officeAndCourtWiseReportVM.CourtTypeId + "," + officeAndCourtWiseReportVM.caseStatus + "";
            var results = _db.Database.SqlQuery<CaseList>(SPname).ToList();
        ...
        private DataTable BindGrid(OfficeAndCourtWiseReportVM officeAndCourtWiseReportVM)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(constring))
            {
                ...
                sqlCmd.Parameters.AddWithValue("@dateFrom", officeAndCourtWiseReportVM.IssueDateFrom);
                sqlCmd.Parameters.AddWithValue("@dateTo", officeAndCourtWiseReportVM.IssueDateTo);
