    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           // $("#ddlMinistryDepartment").data("kendoComboBox").trigger("change");
            ...
            TotalPriority = CardAndPriority.totalPriority;
...
function createBarChart() {
   ...
   //for (let i = 0; i <CategoryMonth.length; i++) {
   //   CategoryMonth.push(0);
   //}

}

function createChart(value) {
   var totalValue = value == undefined ? 0 : value
    $("#chart").kendoChart({
        title: {
          position: "bottom",
          text: "Total Number of Case: " + totalValue
        },
        legend: {
            visible: false
        },
