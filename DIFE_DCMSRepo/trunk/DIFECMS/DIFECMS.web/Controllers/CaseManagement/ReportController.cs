...
namespace DIFECMS.Web.Controllers.CaseManagement
{
    public class ReportController : Controller
    {
        ...
        public JsonResult GetReportData(Int64 id)
        {
         var res = new
         {
            caseRepondentPerson = _caseFacade.GetCaseRepondentPersonOrOrg(id).Where(x => x.isActive == true),
            caseRespondent = _caseFacade.GetRespondentOfficeData(id).Where(y => y.isActive == true),
