...
function SearchFilter() {
    ...
    o.IssueDateFrom = $("#issueDateFrom").val() == undefined ? "" : $("#issueDateFrom").val();
    o.IssueDateTo = $("#issueDateTo").val() == undefined ? "" : $("#issueDateTo").val();
    
   if (!isValidDate(o.IssueDateFrom) && $("#issueDateFrom").val() != "") {
      $("#issueDateFrom").focus();
